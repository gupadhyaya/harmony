...
var (
	...
	SentRequests           = stats.Int64("consensus/sent_requests", "Total number of requests sent per RPC", stats.UnitDimensionless)
	SentRequestErrors      = stats.Int64("consensus/kad/sent_request_errors", "Total number of errors for requests sent per RPC", stats.UnitDimensionless)
